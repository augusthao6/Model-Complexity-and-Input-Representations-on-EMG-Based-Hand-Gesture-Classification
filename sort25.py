...
EX2_gest = [5,6,7,11,12,13,14,15,16,17]
EX3_gest = [1,2,3,4,5,8,9,10,11,12,14,15,16,17]
...
for i in subject_list:
    ...
    spec_emg_data["subject{}".format(i)]={} #Instantiate nested subject specific EMG dictionary
